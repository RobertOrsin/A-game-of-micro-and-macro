...
\item[Movement (M)]
maximum range in cm a unit can move
\item[Attack (A)]
...
Units of the same kind, or bound through other rules, with touching bases can be commanded as a group.
...
The unit or group moves its maximum movement-value in cm, or less.
...
Lance & 2 & 2 & \\
\hline
Bow & 12 & 1 & Doubled damage on a critical roll\\
\hline
...
Claws & 1 & 1 & \\
\hline
Dueling Sword & 1 & 5 & Attack after getting attacked \\
\hline
...
Passive. Units within a 5 cm radius to this unit have an increase attack-attribute by one.
...
Passive. If at least 4 units of the same type with this spell are in a group, their attack and defend ability is increased by one.

\subsubsection{Thats an order!}
Active. Choose a friendly unit within 6 cm. This unit makes one attack action.

\newpage
\subsection{Bloodmages}

\subsubsection{Beacon of Evil}
Passive. If a skeleton is summoned, it can be placed in a 2cm radius around this unit.

\subsubsection{Demonic Leech}
Active. Hurls a demonic leech onto an enemy. Deals 8 damage, heals 4 life-points. 8 cm range.

\subsubsection{Fel Mortar}
Active. Choose an enemy unit within 10 cm range. Roll a D6. Apply the rolled value as damage.
...
Passive. If the unit is within a 2 cm radius of a bloodmage its movement-attribute is increased by 2.

\subsubsection{Unholy Presence}
Skeletons within a 5cm radius have their defense-attribute increased by 1.
...
Passive. If no other friendly unit is within a 10cm radius. Movement-Attribute is increased by 3. Attack and Defense-Attribute are increased by 1.
...
\begin{enumerate}
\item The maindeck contains 40 cards maximum and 30 cards minimum
\begin{enumerate}
